...
public enum ErrorCode {
    ...
    DEPARTMENT_CREATE_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "Internal Server Error"),
    DEPARTMENT_UPDATE_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "Internal Server Error"),
    INTERNAL_DELETE_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "Internal Server Error"),
    INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "Internal Server Error"),
    USER_CREATION_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "User Creation Error"),
    USER_UPDATE_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "User Update Error"),
